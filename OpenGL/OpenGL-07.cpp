...
// ==========================================================================
//  PROGRAM:
//          Implementing a cube, constructed from 12 coloured triangles, and
//          using the Model-View-Projection matrix (MVP) with data from
//          different vertex and color arrays.
// ===========================================================================
...
void init_Resources()
    {
        ...
        window = glfwCreateWindow(800, 600, "COMP3420 - Step 7 - Cube Shaded Triangles", NULL, NULL);
...
void renderScene()
    {
        ...
        Shader cubeShader( "vertex7.glsl", "fragment7.glsl" );

            // Get a handle for our vertices positions buffer.
            // Then we'll pass "vertexPosition" to the vertex shader
        GLuint vertexPositionID = glGetAttribLocation(cubeShader.Program, "vertexPosition");
    
            // Get a handle for our vertices colour buffer.
            // Then we'll pass "vertexColor" to the vertex shader
        GLuint vertexColorID = glGetAttribLocation(cubeShader.Program, "vertexColor");
        ...
        //--- Step 1 ---------------------------------------------------------//
        // Define a handle for our new "MVP" uniform and then we'll pass      //
        // "MVP" to the vertex shader                                         //
        //--------------------------------------------------------------------//
        GLuint MatrixID = glGetUniformLocation(cubeShader.Program, "MVP");
        ...
        //--- Step 5 ---------------------------------------------------------//
        // Now create Our ModelViewProjection (or MVP) matrix : multiplication of our 3 matrices
        //--------------------------------------------------------------------//
        ...
        while ( !glfwWindowShouldClose(window) )
            {
                ...
                //=====================================================================//
                // ...Adding some more new stuff now...                                //
                //=====================================================================//
        ...
        glDeleteProgram(cubeShader.Program);
