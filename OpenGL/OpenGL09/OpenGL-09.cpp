...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        planetModel = glm::translate(planetModel, glm::vec3(0.0f, 0.0f, 1.0f));
        ...
        planetAngle += 0.001;
        1;
        if (planetAngle > 360) planetAngle = 0.001;
        planetModel = glm::rotate(planetModel, planetAngle, glm::vec3(1.0f, 1.0f, 1.0f));
