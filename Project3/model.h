        ...
        for(GLuint i = 0; i < mesh->mNumVertices; i++)
            {
                ...
                {
                  // If normals are not available, you might want to handle this case.
                  // For simplicity, you can set a default normal, but in a real application,
                  // you might want to calculate or provide a default normal.
